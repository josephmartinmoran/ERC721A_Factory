...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    // amount put aside for dev/marketing
    uint256 private amountForDevs;

    // token price
    uint256 private PRICE_PER_TOKEN;
    ...
    constructor(string memory name_, string memory symbol_, uint256 maxBatchSize_, uint256 collectionSize_, uint256 amountForDevs_, uint256 PRICE_PER_TOKEN_) {
        _name = name_;
        _symbol = symbol_;
